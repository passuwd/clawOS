...
src/kernel/userspace.o: src/kernel/userspace.cpp
	$(CXX) $(CXXFLAGS) -c $< -o $@
...
src/kernel/graphics.o: src/kernel/graphics.cpp
	$(CXX) $(CXXFLAGS) -c $< -o $@

src/kernel/gui.o: src/kernel/gui.cpp
	$(CXX) $(CXXFLAGS) -c $< -o $@

src/kernel/heap.o: src/kernel/heap.cpp
	$(CXX) $(CXXFLAGS) -c $< -o $@

src/kernel/vfs.o: src/kernel/vfs.cpp
	$(CXX) $(CXXFLAGS) -c $< -o $@

src/kernel/exfat.o: src/kernel/exfat.cpp
	$(CXX) $(CXXFLAGS) -c $< -o $@
